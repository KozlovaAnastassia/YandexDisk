...
class KeychainManager {
    ...
    func saveTokenInKeychain(_ token: String) {
        do {
            try KeychainManager.shared.save(
                ...
                account: Account.anastasia.rawValue,
    ...
    func getTokenFromKeychain() -> String? {
        guard let data = KeychainManager.shared.get(service: Service.yandex.rawValue, account: Account.anastasia.rawValue) else {
    ...
    func delete() {
        let query: [String: AnyObject] = [
            ...
            kSecAttrAccount as String: Account.anastasia.rawValue as AnyObject,
        ]
